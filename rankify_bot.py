...
# CRITICAL FIX: The token is hardcoded here to bypass environment loading issues 
# on the specific Android hosting app.
BOT_TOKEN = "8048888983:AAFEu89uf0HMYh1cy_mGdPkfqPScKaHm_RU" 
...
# Set database path to current working directory (safe for most hosts)
DB_NAME = os.path.join(os.getcwd(), "rankify_db.sqlite")
...
def main():
    ...
    if not BOT_TOKEN:
        print("CRITICAL ERROR: BOT_TOKEN is empty. Please check the top of the file.")
        return
    ...
    application.add_handler(CommandHandler("legends", legends_command)) 
